<script setup>
import { unref, ref, onMounted, onUnmounted, computed, watch } from "vue";
...
<template>
  <a-spin :spinning="globalLoading" size="large" tip="Loading...">
    <div class="u-flex u-flex-col u-min-h-screen">
      ...
      >
        <p>
          建議瀏覽器版本：最新版本-chrome．Firefox．Safari．Edge © Taiwan
          Nazarene Theological College LMS
        </p>
      </footer>
