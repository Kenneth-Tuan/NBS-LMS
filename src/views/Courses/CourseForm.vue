      ...
      <div class="u-mb-6">
        ...
        <a-row :gutter="16">
          <a-col :span="12">
            ...
            >
              <a-select
                v-model:value="courseStore.courseForm.required_for_departments"
                mode="multiple"
                :placeholder="courseSchema.required_for_departments.placeholder"
          ...
          <a-col :span="12">
            ...
            >
              <a-select
                v-model:value="courseStore.courseForm.prerequisite_course_codes"
                mode="multiple"
                :placeholder="
